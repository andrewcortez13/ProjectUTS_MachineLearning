# -*- coding: utf-8 -*-
"""TugasML5_ChessGame_NaiveBayes

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1MXrO_aS2kyowKs0plI227xasUUhMb1M7
"""
...
# Function yang menangani pemisahan sample, pemasangan model, dan pencetakan laporan
def mfunc(X, y, typ):
...
# Function yang menangani pemisahan sample, pemasangan model, dan pencetakan laporan
# Membuat function lagi, karena jika menggunakan langsung yang tadi, error waktu GaussianNB()
# Function ini digunakan untuk CategoricalNB() dan BernoulliNB()
def mfunc2(X, y, typ):
...
# Fit the model and print the result
X_train, X_test, y_train, y_test, clf, pred_labels = mfunc2(X, y, BernoulliNB())
